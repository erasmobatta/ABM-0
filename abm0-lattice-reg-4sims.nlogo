...
globals[
  ...
  energy-zero
  initial-population-low
  initial-population-high
  cost-perception
  tag
...
patches-own[
 ...
 to setup
  clear-all
  set-default-shape persons "default"
  set tag 0

  set energy-zero 10
  set initial-population-low random 1681
  set initial-population-high random 1681
  set cost-perception 0.5 + random-float 0.3

  create-persons (initial-population-low) [
    set consume 1.5
    set color red
   ...
   create-persons (initial-population-high) [
    set consume 2
    set color blue
    setxy random-xcor random-ycor
    set energy energy-zero
...
; The Model "Rabbits" was used as template
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot tag"
...
This project represents a simple model whit two kind of agents: persons and sources.
Each person has not any kind of reasoning and only born, die, reproduce, consume energy
and get the energy from sources. Sources are part of the environment.
...
This model is inspired in the NetLogo Rabbits Grass Weeds model created by
Uri Wilensky.
...
<experiments>
  <experiment name="experiment" repetitions="30" runMetricsEveryStep="true">
    ...
    <metric>vision-th</metric>
    <metric>test</metric>
    <enumeratedValueSet variable="basal-met">
      <value value="1"/>
    </enumeratedValueSet>
    <steppedValueSet variable="base-area" first="4" step="1" last="15"/>
  </experiment>
  <experiment name="efect-th-persons" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    ...
    <enumeratedValueSet variable="base-area">
      <value value="5"/>
      <value value="11"/>
      <value value="15"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="bMet-bArea-circle1" repetitions="30" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
  ...
  <experiment name="cost-density" repetitions="3000" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>count persons</metric>
    <metric>low-fraction</metric>
    <metric>initial-population-high</metric>
    <metric>initial-population-low</metric>
    <metric>cost-perception</metric>
  ...
  <experiment name="reg-lat1" repetitions="1000" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>count persons</metric>
    ...
    <steppedValueSet variable="reg-time" first="10" step="1" last="15"/>
  ...
  <experiment name="reg-comp4" repetitions="1000" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="1000"/>
    <metric>count persons</metric>
    ...
    <enumeratedValueSet variable="reg-time">
      <value value="100"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="regeneration?">
      <value value="true"/>
